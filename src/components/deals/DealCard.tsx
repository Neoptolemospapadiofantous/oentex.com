// src/components/deals/DealCard.tsx - Enhanced with Real Community Ratings
...
export const DealCard: React.FC<DealCardProps> = ({ 
  ...
  // ✅ FIXED: Get real aggregated rating data from trading_companies table
  ...
  return (
    <div className="group bg-surface rounded-2xl border border-border hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 overflow-hidden">
      ...
      <div className="p-6 pb-4">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* ✅ ENHANCED: Real community rating display */}
              <div className="mt-1">
                {totalRatings > 0 ? (
        ...
        {/* ✅ ENHANCED: Community Trust Section */}
