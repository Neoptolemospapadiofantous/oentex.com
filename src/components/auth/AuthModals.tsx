...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, mode, onModeChange }) => {
  ...
  // ✅ FIX: Disable body scroll when modal is open
  useEffect(() => {
    if (isOpen) {
  ...
  return (
    // ✅ FIX: Proper modal overlay with fixed positioning and backdrop click handling
    <div 
      className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4"
      onClick={handleBackdropClick}
    >
      <FocusManager trapFocus restoreFocus>
        {/* ✅ FIX: Modal container with proper positioning and scroll handling */}
        <div 
          className="bg-surface rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto relative border border-border"
        ...
        >
          <div className="p-6">
            <button 
              onClick={handleClose}
              disabled={isLoading}
              className="absolute top-4 right-4 text-textSecondary hover:text-text transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onBlur={handleBlur}
                      disabled={isLoading}
                      className={`w-full pl-10 pr-4 py-3 bg-background border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onBlur={handleBlur}
                      disabled={isLoading}
                      className={`w-full pl-10 pr-12 py-3 bg-background border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-textSecondary hover:text-text disabled:opacity-50 disabled:cursor-not-allowed"
