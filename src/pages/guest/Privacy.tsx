      ...
      <div className="min-h-screen pb-12">
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto container-p-2xl">
            ...
            {/* Footer Notice */}
            <div className="mt-20 container-p-lg bg-secondary/10 border border-secondary/20 rounded-2xl">
              <div className="flex items-start space-x-4">
                <Icons.shield className="w-6 h-6 text-secondary flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-foreground mb-3">Your Privacy is Our Priority</h3>
