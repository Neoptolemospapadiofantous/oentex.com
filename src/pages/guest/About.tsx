        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-xl p-6 border border-primary/20">
                  ...
                  <p className="text-foreground/70 text-sm mt-2">— Our Core Philosophy</p>
                </div>
              </div>
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center text-sm text-foreground/70">
                        <Icons.success className="w-4 h-4 text-secondary mr-2 flex-shrink-0" />
                        {feature}
                      </li>
                    ))}
                  </ul>
          ...
          <div className="bg-gradient-to-r from-warning/10 to-accent/10 border border-warning/30 rounded-2xl p-6 mb-16">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">Transparency Disclosure</h3>
          ...
          <div className="text-center bg-gradient-to-r from-primary/10 to-secondary/10 rounded-3xl p-8 lg:p-12 border border-primary/20">
            <h2 className="text-3xl font-bold text-foreground mb-4">Ready to Discover Great Deals?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button 
                ...
                className="border border-primary text-primary px-8 py-3 rounded-full font-medium hover:bg-primary hover:text-white transition-colors duration-300"
              >
                Contact Us
              </button>
            </div>
