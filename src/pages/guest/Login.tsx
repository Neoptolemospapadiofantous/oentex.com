// src/pages/guest/Login.tsx - Dedicated Login Page
...
export const Login: React.FC = () => {
  ...
  if (state.success) {
    return (
      <div className="min-h-screen pt-20 flex items-center justify-center bg-gradient-to-br from-background via-default-50 to-background px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-success/8 via-primary/6 to-success/8 backdrop-blur-sm"></div>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-40 right-20 w-24 h-24 bg-primary/12 rounded-full blur-lg animate-pulse delay-1000"></div>
          <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-success/10 rounded-full blur-2xl animate-pulse delay-2000"></div>
          <div className="absolute bottom-20 right-1/3 w-28 h-28 bg-primary/8 rounded-full blur-xl animate-pulse delay-3000"></div>
        </div>
  ...
  return (
    <div className="min-h-screen pt-20 flex items-center justify-center bg-gradient-to-br from-background via-default-50 to-background px-6 relative overflow-hidden">
      {/* Rich animated background */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary/8 via-secondary/6 to-primary/8 backdrop-blur-sm"></div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-primary/8 rounded-full blur-2xl animate-pulse delay-2000"></div>
        <div className="absolute bottom-20 right-1/3 w-28 h-28 bg-secondary/12 rounded-full blur-xl animate-pulse delay-3000"></div>
      </div>
      ...
      <Card className="max-w-2xl w-full shadow-2xl border border-divider/50 relative z-10 backdrop-blur-md bg-content1/95 animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-700">
        <CardHeader className="text-center section-py-xl section-px-lg bg-gradient-to-r from-content1 via-content2/50 to-content1 border-b border-divider/30 flex flex-col items-center justify-center">
          <div className="w-full space-y-4 flex flex-col items-center">
            <div className="w-20 h-20 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center mb-6 shadow-lg animate-in zoom-in-95 duration-500 delay-200">
              <img 
                src={logo} 
                alt="Oentex Logo" 
